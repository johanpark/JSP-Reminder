...
<body class="pt-5">
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		<a class="navbar-brand" href="/Reminder/list"><i
			class="far fa-calendar-alt">Reminder</i></a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link"
					href="/Reminder/list">Home <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<!--   <a class="nav-link" href="../board/board.jsp">Board</a> -->
					<a class="nav-link" href="/Reminder/boardList.do">Board</a>
				</li>
				...
				<li class="nav-item"><a class="nav-link"
					href="/Reminder/views/login/login.jsp">Login</a></li>
				<%
					} else {
				%>
				<li class="nav-item"><a class="nav-link"
					href="/Reminder/calendarList.do">Calendar</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/Reminder/views/login/logout.jsp">Logout</a></li>
				<%
					}
				%>
			</ul>
